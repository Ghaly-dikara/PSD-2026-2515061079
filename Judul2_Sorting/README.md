...
Sistem ini merupakan sistem yang berjalan di python dengan menggunakan Selection Sort untuk mengelola data nilai mahasiswa yang telah diinputkan. yang pertama dalam program ini berisikan fungsi untuk menukar nilai dari variabel temp yang akan menyimpan nilai dari array ber indeks i dan array dengan indeks i akan menyimpan nilai dari array berindeks j, serta array berindeks j yang akan menyimpan nilai dari variabel temp. fungsi dibuat untuk menukar nilai dari variabel dan digunakan dalam fungsi selection sort. Selanjutnya ada fungsi selection sort yang akan mencari elemen yang terkecil dan menggunakan fungsi tukar untuk menukar nilai dari elemen. Setelah itu ada fungsi untuk mengklasifikasikan, A untuk nilai lebih dari sama dengan 76, B untuk nilai lebih dari sama dengan 66, C untuk lebih dari sama dengan 55, D untuk nilai lebih dari sama dengan 50, dan D untuk nilai lainnya.

Yang terakhir ada fungsi utama yang meminta input berapa banyak nilai mahasiswa yang ingin di kelola, setelah itu meminta input nilai-nilai mahasiswa. didalam fungsi ini juga ada fitur untuk menghitung rata-rata nilai yang diinput. Dan yang terakhir akan menampilkan nilai sebelum diurutkan dengan selection sort, serta menampilkan nilai setelah diurutkan. Dan setelahnya ada klasifikasi nilai menggunakan fungsi klasifikasi nilai.
