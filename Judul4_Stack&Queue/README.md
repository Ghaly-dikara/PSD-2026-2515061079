...
Class StackArray digunakan untuk membuat stack yang dimana setiap ada StackArray tidak diperlukan pemanggilan, fungsi is_empty(self) untuk cek apakah Stack kosong atau tidak, fungsi is_full(self) mengecek stack penuh atau tidak, fungsi push(self, x) yang berguna untuk menambahkan history browsing ke dalam stack. Fungsi pop(self) berguna untuk menghapus elemen terakhir pada array, dalam kasus ini digunakan untuk keluar dari halaman website yang terakhir diakses, fungsi peek(self) untuk menampilkan situs yang sedang diakses (digunakan untuk mengakses elemen terakhir stack tanpa menghapusnya, dan fungsi display(self) yang berfungsi untuk menampilkan full history browser dari yang terbaru ke yang terlama. Terakhir adalah fungsi utama, yang berisikan menu-menu untuk mengunjungi web, kembali, lihat halaman sekarang yang sedang diakses, dan keluar dari browser.
...
### Youtube: https://youtu.be/M-ok43rHO-A
